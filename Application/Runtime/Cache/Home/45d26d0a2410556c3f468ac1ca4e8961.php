        ...
        <div class="row">
            <div id="main-content" class="col-md-8">
                <div class="goods-select">
                    <div class="heading"><h4>商品筛选</h4></div>
                    <div class="content">
                       <p>
                           <strong>品牌：</strong>
                           <?php if(is_array($data['search']['brand'])): $i = 0; $__LIST__ = $data['search']['brand'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;?><a href="<?php echo ($brand['url']); ?>" <?php if(($brand['isSelected']) == "1"): ?>class="selected"<?php endif; ?>>
                               <?php echo ($brand['name']); ?>
                            </a><?php endforeach; endif; else: echo "" ;endif; ?>
                       </p>
                       <?php if(is_array($data['search']['attr'])): $i = 0; $__LIST__ = $data['search']['attr'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$search): $mod = ($i % 2 );++$i;?><p>
                               <strong><?php echo ($search['name']); ?>：</strong>
                               <?php if(is_array($search['values'])): $i = 0; $__LIST__ = $search['values'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="<?php echo ($search['url'][$key]); ?>" <?php if($search['isSelected'][$key] == 1): ?>class="selected"<?php endif; ?>><?php echo ($v); ?>
                                       </a><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div id="sidebar" class="col-md-4 ">
                <div class="widget wid-categories">
                    ...
                    <div class="content">
                        <ul>
                            <?php if(is_array($data['leftCategory'])): $i = 0; $__LIST__ = $data['leftCategory'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leftCategory): $mod = ($i % 2 );++$i;?><li <?php if(($leftCategory['id']) == $data['id']): ?>class="active"<?php endif; ?>>
