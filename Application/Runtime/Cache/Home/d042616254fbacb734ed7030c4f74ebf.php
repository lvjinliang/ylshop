...
<!--Top-->
    ...
    <div class="container">
        ...
        <input type="hidden" name="get_content_url" value="<?php echo U('Home/checkout/ajax_get_content');?>" />
        <input type="hidden" name="get_order_url" value="<?php echo U('Home/checkout/order');?>" />
        <input type="hidden" name="get_success_url" value="<?php echo U('Home/checkout/success');?>" />
        <div class="checkout-content">
        <?php echo ($data['checkout-content']); ?>
        </div>
    </div>
</div>
<div id="dialog" title="">
